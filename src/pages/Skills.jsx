...
import gojo from '/gojo body.png'
...
export const Skills = () => {
  ...
  <div className='skill-img  flex gap-10 flex-wrap  w-100 ml-10'>
    ...
    <p className='white'>JavaScript</p>
    </div>
   
   
    <div className='flex gap-3   w-fit items-center px-4 py-2'>
    <img src="public/image/bootsrap.png" alt="" />
    <p className='white'>Bootstrap</p>
    </div>

    
    <div className='flex gap-3   w-fit items-center px-4 py-2'>
    <img src="public/tailwind.png" alt="" />
    <p className='white'>Tailwind</p>
    </div>
